...
export const payments = [
  { id: 'pay1', clientId: 'c1', amount: 1000, status: 'paid', date: '2026-07-01', method: 'stripe', tier: 'the competitor' },
  { id: 'pay2', clientId: 'c2', amount: 500, status: 'paid', date: '2026-07-01', method: 'stripe', tier: 'the mentorship' },
  { id: 'pay3', clientId: 'c3', amount: 250, status: 'paid', date: '2026-06-15', method: 'stripe', tier: 'the blueprint' },
  { id: 'pay4', clientId: 'c4', amount: 1000, status: 'paid', date: '2026-07-01', method: 'stripe', tier: 'the competitor' },
  { id: 'pay5', clientId: 'c1', amount: 1000, status: 'paid', date: '2026-06-01', method: 'stripe', tier: 'the competitor' },
  { id: 'pay6', clientId: 'c2', amount: 500, status: 'paid', date: '2026-06-01', method: 'stripe', tier: 'the mentorship' },
];
