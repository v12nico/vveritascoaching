...
export const SECTIONS = [
  ...
  // ── the history ─────────────────────────────────────────────────────────────
  // Where they came from and what they have been doing to get here. Current
  // weight alone cannot tell the difference between someone who has never
  // dieted and someone two years into a deficit, and those two people need
  // opposite plans. `typicalDay` is the single most useful field in this form.
  {
    key: 'history',
    num: '02',
    label: 'the history',
    headline: 'where you\u2019ve been.',
    sub: 'this decides the plan more than your current weight does.',
    screens: [
      {
        fields: [
          { id: 'highestWeight', q: 'highest weight you\u2019ve been (lbs)', type: 'number', ph: '—', optional: true },
          { id: 'weightLost', q: 'how much have you lost so far (lbs)', type: 'number', ph: '0', optional: true },
          { id: 'dietingMonths', q: 'how many months have you been trying to lose', type: 'number', ph: '—', optional: true },
        ],
      },
      {
        fields: [
          {
            id: 'typicalDay',
            q: 'walk me through a normal day of eating right now',
            hint: 'be honest, not impressive. times and rough portions are enough.',
            type: 'textarea',
            ph: 'woke up, didn\u2019t eat until 11...',
          },
        ],
      },
      {
        fields: [
          {
            id: 'tracking',
            q: 'are you tracking calories?',
            type: 'single',
            opts: ['no', 'roughly', 'yes, every day'],
          },
          { id: 'calorieTarget', q: 'if yes, roughly how many a day', type: 'number', ph: '—', optional: true },
          {
            id: 'liftedBefore',
            q: 'have you trained with weights consistently before?',
            type: 'single',
            opts: ['never', 'a little', 'on and off', 'yes, for years'],
          },
        ],
      },
      {
        fields: [
          { id: 'waist', q: 'waist (inches)', type: 'number', ph: 'optional', optional: true },
          { id: 'hips', q: 'hips (inches)', type: 'number', ph: 'optional', optional: true },
          {
            id: 'progressNote',
            q: 'anything about your body you want me to know that a number won\u2019t tell me?',
            type: 'textarea',
            ph: 'optional',
            optional: true,
          },
    ...
    screens: [
      ...
      },
      {
        fields: [
          {
            id: 'dailySteps',
            q: 'roughly how many steps do you get on a normal day?',
            hint: 'outside of training. this changes your food more than almost anything else here.',
            type: 'single',
            opts: ['under 5k', '5–10k', '10–15k', '15k+', 'not sure'],
          },
        ],
      },
      {
        fields: [
          {
            id: 'gymAccess',
            q: 'where will you be training, and what does it have?',
            hint: 'i write the movements around what you can actually get to.',
            type: 'textarea',
            max: LIMITS.short,
            ph: 'commercial gym / home setup / machines, racks, dumbbells',
          },
        ],
      },
      {
