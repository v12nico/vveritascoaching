...
export const olaf = {
  ...
  week1: {
    ...
    targets: [
      ...
      'eat before 9am on work days — the meal you keep skipping',
    ],
  },
  ...
  training: {
    ...
    cardio: {
      ...
      note: 'drop the hiit. you walked an hour to the gym and then did 15 minutes of '
          + 'intervals — at 146 lb trying to gain, that’s work you have to eat back. '
          + 'the walk stays. the intervals go.',
    },
  },
  ...
  followUp: 'you wake at 8 and work at 9. that’s an hour, and right now none of it '
          + 'goes to food — every check-in so far has your first meal at 12 or 1. '
          + 'eat inside that hour. that is the whole fix this week.',
}
