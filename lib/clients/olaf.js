...
export const olaf = {
  ...
  nutrition: {
    ...
    meals: [
      { slot: 'meal 1 — morning, before work', protein: '30–40 g',
        options: ['eggs', 'greek yogurt or cottage cheese', 'potatoes', 'fruit', 'milk'] },
      { slot: 'work meal — portable', protein: '30–40 g',
        options: ['ready-to-drink protein or whey + whole milk', 'greek yogurt', 'aged cheese',
      ...
      { slot: 'evening / post-workout', protein: '30–40 g',
