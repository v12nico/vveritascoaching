...
export const fanta = {
  ...
  // No missed-check-in alerts for her. She is on five and a half hours of sleep
  // with stress at 8 and money as the thing that could end this — a nightly
  // "you didn't check in" is one more thing failing at her on a hard day.
  // Everyone else is opted in by default.
  alerts: { missedCheckin: false },
