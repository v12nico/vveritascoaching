...
const NOTES = [
  ...
  { n: 13, title: `$200 a week. 8 weeks.`,
    note: `DO NOT say the number first. Walk the arithmetic and let her do the adding. "Personal training around here runs seventy-five to a hundred fifty a session. Eight sessions at a hundred is eight hundred — that's just the hours, no programming, no app, nobody checking on you." Pause. "The program, the app, the check-ins, the weekly rewrites — that's another eight hundred on its own." Pause. "Together it's sixteen hundred. Which is two hundred a week." THREE SECONDS OF SILENCE. Then: "That's not a bundle discount. That's just what the pieces cost. What you're actually getting that nobody else gives you is the hour AND the six days after it." Then: "Does that match what you said you needed?" STOP TALKING. — IF PRICE OBJECTION: ask "is it the number or the timing?" If timing, offer a start date, not a discount. If it's genuinely the number, the ONLY move is fewer in-person sessions: every other Sunday at $140/wk, app running all eight weeks either way. NEVER cut the weekly rate for the same service — it sets your floor for every in-person client after her, and she is the first.` },
